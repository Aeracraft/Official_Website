          ...
          <div class="flex items-center gap-1 sm:gap-1.5">
            <div class="hidden sm:flex items-center gap-1.5">
              ...
              <a v-for="s in appConfig.site.socials" :key="s.url" :href="s.url" target="_blank" class="p-2 rounded-lg text-gray-500 dark:text-white/40 hover:text-gray-900 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 transition-all" :title="s.name">
                ...
                <svg v-else-if="s.icon === 'svg:qq'" class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M21.395 15.035a39.548 39.548 0 0 0-1.296-3.522c.174-1.392.266-2.873.266-4.413C20.365 4.054 16.559 0 12 0 7.441 0 3.635 4.054 3.635 7.1c0 1.54.092 3.021.266 4.413a39.548 39.548 0 0 0-1.296 3.522c-.388 1.556-.17 2.558.27 3.044.442.485 1.458.634 2.958.304a39.875 39.875 0 0 0 4.364 2.583c-.105.578-.166 1.186-.166 1.818 0 .914-.37 1.64-.825 1.64s-.825-.726-.825-1.64c0-.632-.061-1.24-.166-1.818a39.875 39.875 0 0 0 4.364-2.583c1.5.33 2.516.181 2.958-.304.44-.486.658-1.488.27-3.044ZM8.585 7.792c0-1.88 1.68-3.405 3.75-3.405s3.75 1.526 3.75 3.405c0 1.88-1.68 3.405-3.75 3.405s-3.75-1.526-3.75-3.405Zm-.36 4.368c-1.392-.657-2.962-1.308-4.636-1.812a16.987 16.987 0 0 1-.07-1.148c0-2.568 2.208-4.65 4.925-4.65.21 0 .418.014.623.04-.548 1.105-.862 2.34-.862 3.65 0 1.34.338 2.602.93 3.673-.13.39-.27.773-.42 1.148-.164.054-.33.106-.497.157h-.004Zm8.474 0a13.213 13.213 0 0 1-.497-.157c-.15-.375-.292-.758-.42-1.148.592-1.071.93-2.333.93-3.673 0-1.31-.314-2.545-.862-3.65.205-.026.413-.04.623-.04 2.717 0 4.925 2.082 4.925 4.65 0 .39-.023.774-.07 1.148-1.674.504-3.244 1.155-4.636 1.812ZM12 16.5c-2.14 0-3.65.796-3.65 1.86 0 .588.643 1.06 1.44 1.06.55 0 1.026-.195 1.395-.51.21.033.426.05.615.05s.405-.017.615-.05c.369.315.845.51 1.395.51.797 0 1.44-.472 1.44-1.06 0-1.064-1.51-1.86-3.65-1.86Z"/></svg>
        ...
        <div class="flex items-center gap-4">
          <template v-for="s in appConfig.site.socials" :key="s.url">
            <a :href="s.url" target="_blank" class="social-icon" :title="s.name">
              ...
              <svg v-else-if="s.icon === 'svg:qq'" class="w-[16px] h-[16px]" fill="currentColor" viewBox="0 0 24 24"><path d="M21.395 15.035a39.548 39.548 0 0 0-1.296-3.522c.174-1.392.266-2.873.266-4.413C20.365 4.054 16.559 0 12 0 7.441 0 3.635 4.054 3.635 7.1c0 1.54.092 3.021.266 4.413a39.548 39.548 0 0 0-1.296 3.522c-.388 1.556-.17 2.558.27 3.044.442.485 1.458.634 2.958.304a39.875 39.875 0 0 0 4.364 2.583c-.105.578-.166 1.186-.166 1.818 0 .914-.37 1.64-.825 1.64s-.825-.726-.825-1.64c0-.632-.061-1.24-.166-1.818a39.875 39.875 0 0 0 4.364-2.583c1.5.33 2.516.181 2.958-.304.44-.486.658-1.488.27-3.044ZM8.585 7.792c0-1.88 1.68-3.405 3.75-3.405s3.75 1.526 3.75 3.405c0 1.88-1.68 3.405-3.75 3.405s-3.75-1.526-3.75-3.405Zm-.36 4.368c-1.392-.657-2.962-1.308-4.636-1.812a16.987 16.987 0 0 1-.07-1.148c0-2.568 2.208-4.65 4.925-4.65.21 0 .418.014.623.04-.548 1.105-.862 2.34-.862 3.65 0 1.34.338 2.602.93 3.673-.13.39-.27.773-.42 1.148-.164.054-.33.106-.497.157h-.004Zm8.474 0a13.213 13.213 0 0 1-.497-.157c-.15-.375-.292-.758-.42-1.148.592-1.071.93-2.333.93-3.673 0-1.31-.314-2.545-.862-3.65.205-.026.413-.04.623-.04 2.717 0 4.925 2.082 4.925 4.65 0 .39-.023.774-.07 1.148-1.674.504-3.244 1.155-4.636 1.812ZM12 16.5c-2.14 0-3.65.796-3.65 1.86 0 .588.643 1.06 1.44 1.06.55 0 1.026-.195 1.395-.51.21.033.426.05.615.05s.405-.017.615-.05c.369.315.845.51 1.395.51.797 0 1.44-.472 1.44-1.06 0-1.064-1.51-1.86-3.65-1.86Z"/></svg>
