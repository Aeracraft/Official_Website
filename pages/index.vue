        ...
        <div class="flex items-center gap-4">
          <template v-for="s in appConfig.site.socials" :key="s.url">
            <a :href="s.url" target="_blank" class="social-icon" :title="s.name">
              ...
              <svg v-else-if="s.icon === 'svg:qq'" class="w-[16px] h-[16px]" fill="currentColor" viewBox="0 0 24 24"><path d="M12.003 2C6.004 2 3 6.59 3 10.02c0 1.956.652 3.77 1.73 5.167-.08.832-.308 2.12-.563 3.107-.105.41-.228.787-.298.974-.08.212-.16.384-.16.384s.395-.012.858-.012c.288 0 .656.037 1.044.09.68.094 1.596.213 1.888.213.292 0 1.208-.119 1.888-.213.388-.053.756-.09 1.044-.09.463 0 .858.012.858.012s-.08-.172-.16-.384c-.07-.187-.193-.564-.298-.974-.255-.987-.483-2.275-.563-3.107C15.35 13.79 16 11.976 16 10.02 16 6.59 14.002 2 12.003 2Zm0 2.16c.37 0 1.44 1.9 1.44 4.04 0 1.228-.424 2.22-.96 2.952l-.18.248c.224-.008.448-.016.66-.016.12 0 .24.004.36.012a8.19 8.19 0 0 0-.48-1.144c-.44-.788-1-1.6-1-2.56 0-1.36.7-2.52 1.44-3.24a7.282 7.282 0 0 0-1.28-.292Z"/></svg>
